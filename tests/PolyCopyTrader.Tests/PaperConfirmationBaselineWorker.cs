// Frozen pre-change worker from aa6f2cd3, for the approved synthetic comparison only.
...
public sealed class PaperConfirmationBaselineWorker(
    ILogger<PaperConfirmationBaselineWorker> logger,
