...
public sealed class ConfigurationTests
{
    ...
    public void DefaultConfiguration_IsValid()
    {
        ...
        Assert.Equal(8, configuration.BtcUpDown5mStrategy.FastDiffReservedEntryDecisionSlots);
        Assert.Equal(5_000, configuration.BtcUpDown5mStrategy.ObservationMarketSnapshotTtlMilliseconds);
        Assert.Equal(60, configuration.BtcUpDown5mStrategy.ChildParentRefreshDelaySeconds);
        ...
        Assert.Equal(5, configuration.PaperTrading.CopiedTraderPerformanceReconciliationWalletBatchSize);
    ...
    public void BtcUpDown5mStrategyOptions_AreValidated()
    {
        var configuration = new AppConfiguration
        {
            BtcUpDown5mStrategy = new BtcUpDown5mStrategyOptions
            {
                ...
                FastDiffReservedEntryDecisionSlots = 32,
                ObservationMarketSnapshotTtlMilliseconds = 99,
                ChildParentRefreshDelaySeconds = 241,
        ...
        Assert.Contains(errors, error => error.Contains("BtcUpDown5mStrategy.FastDiffReservedEntryDecisionSlots", StringComparison.Ordinal));
        Assert.Contains(errors, error => error.Contains("BtcUpDown5mStrategy.ObservationMarketSnapshotTtlMilliseconds", StringComparison.Ordinal));
        Assert.Contains(errors, error => error.Contains("BtcUpDown5mStrategy.ChildParentRefreshDelaySeconds", StringComparison.Ordinal));
    ...
    public void PaperTradingOptions_AreValidated()
    {
        var configuration = new AppConfiguration
        {
            PaperTrading = new PaperTradingOptions
            {
                ...
                CopiedTraderPerformanceReconciliationWalletBatchSize = 0,
        ...
        Assert.Contains(errors, error => error.Contains("PaperTrading.CopiedTraderPerformanceReconciliationWalletBatchSize", StringComparison.Ordinal));
