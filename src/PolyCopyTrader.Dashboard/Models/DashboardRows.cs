...
public sealed partial class StrategyPerformanceRow : ObservableObject
{
        ...
        string lastRunUtc)
    {
        ...
        this.paperLostCounter = paperLostCounter;
        this.liveLostCounter = liveLostCounter;
        ...
        LiveIgnoredGtdUnfilledCount = liveIgnoredGtdUnfilledCount;
        LiveIgnoredCancelledOrdersCount = liveIgnoredCancelledOrdersCount;
        LiveIgnoredRejectedOrdersCount = liveIgnoredRejectedOrdersCount;
    ...
    public bool AutoLivePaused { get; }
    ...
    [ObservableProperty]
    private int paperLostCounter;

    [ObservableProperty]
    private int liveLostCounter;
    ...
    public int LiveConditionSkippedOrdersCount { get; }

    public int LiveTechnicalSkippedOrdersCount { get; }

    public int LiveIgnoredOrdersCount { get; }

    public int LiveIgnoredGtdUnfilledCount { get; }

    public int LiveIgnoredCancelledOrdersCount { get; }

    public int LiveIgnoredRejectedOrdersCount { get; }
