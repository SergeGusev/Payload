...
- Implemented live trading is BUY-only, tiny-size, and disabled by default. The legacy Follow Leader live path remains tightly gated; the BTC paper/live shadow test path is limited to explicitly allowed BTC variants, currently `BTC Up or Down 5m Skip 1`, `BTC Up or Down 5m Binance 1 bps`, `BTC Up or Down 5m Binance 1.8 bps`, `BTC Up or Down 5m Binance 1.9 bps`, `BTC Up or Down 5m Binance 2 bps`, `BTC Up or Down 5m Binance 2 bps Instant`, `BTC Up or Down 5m Binance 2.1 bps`, `BTC Up or Down 5m Binance 2.2 bps`, and `BTC Up or Down 5m Binance 2.3 bps`, and submits GTD limit BUY orders with `post_only=false`, a local market-relative cancel deadline, and a CLOB GTD expiration that includes the configured security buffer. ETH/SOL Binance bps variants are Paper-only and are not in the live allowlist.
