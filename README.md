...
Before an opening-limit GTD order can expire, both the scheduled Paper open-order worker and the market-data updater run the same conservative submit-snapshot fill guard.
