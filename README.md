...
- Strategies: all configured strategies, including `Follow leader`, with editable enable/live-stake/live-balance controls, Paper orders, open positions, lifecycle runs, entry-delay health, wins/losses, PnL, live-snapshot ROI, split live skip/ignored counts, and closed-only ROI.
- Strategies / 24 hours, 6 hours, 1 hour: short strategy slices with recent order/fill/expiry/settlement counts, ROI, average fill price, entry-delay health, split live skip/ignored counts, and top skip reason.
