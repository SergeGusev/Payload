...
- The default `StrategiesOnlyMode=true` screen shows only the strategy tabs below plus the database selector, service banner, refresh button, and strategy edit controls.
