...
public static class PolymarketJsonParser
{
    ...
    private static bool ContainsAnyCategoryTerm(string text, params string[] terms)
    {
        return terms.Any(term =>
        {
            ...
            return normalized.Length > 0 && text.IndexOf(" " + normalized + " ", StringComparison.Ordinal) >= 0;
        });
    }
    ...
    {
        return value <= 0 ? new DateTimeOffset(1970, 1, 1, 0, 0, 0, TimeSpan.Zero) : DateTimeOffset.FromUnixTimeSeconds(value);
    }
