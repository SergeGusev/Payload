...
public static class BtcUpDown5mMarketAnalyzer
{
    ...
    public static DateTimeOffset? GetWindowStartUtc(PolymarketGammaMarket market)
    {
        ...
        {
            var match = UpDown5mSlugRegexValue.Match(slug);
            if (match.Success &&
    ...
    {
        return !string.IsNullOrWhiteSpace(slug) && UpDown5mSlugRegexValue.IsMatch(slug);
    }
