...
const string TargetIdValue = "b7c50005-0000-4000-8022-000000150070";
const string TargetCode = "btc_up_down_5m_more_150_gamma_below_70";
const string TargetName = "BTC Up or Down 5m More 150 Gamma Below 70";
const string TargetWallet = "strategy:btc_up_down_5m_more_150_gamma_below_70";
...
{
    ApplicationName = "DeleteMore150GammaBelow70"
};
