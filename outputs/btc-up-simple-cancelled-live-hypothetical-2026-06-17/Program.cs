...
const string StrategyName = "BTC Up or Down 5m Up Simple";
const string DefaultOutputDirectory = "outputs/btc-up-simple-cancelled-live-hypothetical-2026-06-17";
...
{
    ApplicationName = "BtcUpSimpleCancelledLiveHypothetical",
    Timeout = 10,
    CommandTimeout = 60
};
