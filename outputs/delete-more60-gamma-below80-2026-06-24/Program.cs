...
const string TargetIdValue = "b7c50005-0000-4000-8022-000000060080";
const string TargetCode = "btc_up_down_5m_more_60_gamma_below_80";
const string TargetName = "BTC Up or Down 5m More 60 Gamma Below 80";
const string TargetWallet = "strategy:btc_up_down_5m_more_60_gamma_below_80";
...
{
    ApplicationName = "DeleteMore60GammaBelow80"
};
